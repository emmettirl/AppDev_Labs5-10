...
public class LoggingAspect {
    ...
    @Before(value = "execution(* app.dev.labs.appdev_labs510.repositories.HouseholdRepository.findHouseholdsWithNoPets(..))")
    ...
    @After(value = "execution(* app.dev.labs.appdev_labs510.repositories.HouseholdRepository.findHouseholdsWithNoPets(..))")
    ...
    @AfterReturning(value = "execution(* app.dev.labs.appdev_labs510.repositories.HouseholdRepository.findHouseholdsWithNoPets(..))", returning = "result")
    ...
    @AfterThrowing(value = "execution(* app.dev.labs.appdev_labs510.repositories.HouseholdRepository.findHouseholdsWithNoPets(..))", throwing = "exception")
    ...
    @Around(value = "execution(* app.dev.labs.appdev_labs510.repositories.HouseholdRepository.findHouseholdsWithNoPets(..))")
